import { Package, ShieldCheck, Wrench, GitBranch, Users, FlaskConical, FileText, LayoutGrid } from "lucide-react";
  ...
  return (
    <section className="border-b border-line">
      <div className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-2 max-w-2xl text-sm text-ink-muted">Eight engineering dimensions combine into one explainable score. Every finding traces back to real, retrieved data — nothing is fabricated to fill a gap.</p>
